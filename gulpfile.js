...
gulp.task("build", ["html", "browserify", "styles", "css"], function () {
  var html = gulp.src("build/index.html").pipe(gulp.dest("./dist/"));

  var js = gulp.src("build/main.js").pipe(uglify()).pipe(gulp.dest("./dist/"));
  var css = gulp.src("build/style.css").pipe(gulp.dest("./dist/"));
  return merge(html, js, css);
});

gulp.task("default", ["html", "browserify", "styles", "css"], function () {
